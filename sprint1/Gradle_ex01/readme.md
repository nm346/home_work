...
* Once you have cloned the repository, import the project Gradle_ex01 using the Gradle import facility in your IDE:
  - File > Import...
  - Gradle project
  - Select the project `Gradle_ex01` and import the project
* Solve the exercises in the `build.gradle` script.
